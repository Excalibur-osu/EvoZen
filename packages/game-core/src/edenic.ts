...
export const EDENIC_BUILDINGS: EdenicBuildingDef[] = [
  ...
  { id: 'elerium_containment', region: 'elysium', name: '超铀控制室',   desc: '控制超铀爆炸反应。',                         reqs: { elysium: 8 },                           baseCost: { Money: 5e10, Elerium: 500000 }, costMult: 1.235, power: 8, effectDesc: '+ Elerium 容量。' },

...
export const TRUEPATH_BUILDINGS: TruepathBuildingDef[] = [
  ...
  { id: 'electrolysis',     region: 'titan', name: '水电解装置',   desc: '从水中提取氢和氧。',                         reqs: { titan: 2 },                       baseCost: { Money: 1750000, Iron: 250000, Steel: 175000 }, costMult: 1.32, power: 4, effectDesc: '生产 Hydrogen 与 Oxygen。' },
  { id: 'hydrogen_plant',   region: 'titan', name: '氢气厂',       desc: '将氢气压缩为可使用燃料。',                   reqs: { titan: 2 },                       baseCost: { Money: 1250000, Adamantite: 75000, Nano_Tube: 35000 }, costMult: 1.32, power: -22, effectDesc: '消耗 Hydrogen 发电 22 MW。' },
  ...
  { id: 'titan_bank',       region: 'titan', name: '土卫六银行',   desc: '为殖民地服务的金融机构。',                   reqs: { titan: 4 },                       baseCost: { Money: 5000000, Cement: 200000, Plywood: 150000, Furs: 95000 }, costMult: 1.32, power: 0, effectDesc: '+1.25M Money 容量。' },
  ...
  { id: 'water_freighter',   region: 'enceladus', name: '水货船',     desc: '将土卫二的水运输到土卫六。',                 reqs: { enceladus: 2 },                  baseCost: { Money: 3750000, Polymer: 500000, Mythril: 35000, Aerogel: 17500 }, costMult: 1.32, power: 1, effectDesc: '生产 Water。' },
  ...
  { id: 'orichalcum_mine',  region: 'kuiper', name: '黄金矿',         desc: '采集 Orichalcum 黄金矿。',                   reqs: { kuiper: 2 },                       baseCost: { Money: 32500000, Adamantite: 1500000, Aerogel: 350000, Vitreloy: 12500 }, costMult: 1.28, power: 7, effectDesc: '+ Orichalcum 产出。' },
  { id: 'elerium_mine',     region: 'kuiper', name: '超铀矿',         desc: '采集 Elerium 矿。',                          reqs: { kuiper: 2 },                       baseCost: { Money: 32500000, Adamantite: 1500000, Aerogel: 350000, Vitreloy: 12500 }, costMult: 1.28, power: 8, effectDesc: '+ Elerium 产出。' },
  { id: 'uranium_mine',     region: 'kuiper', name: '铀矿',           desc: '从柯伊伯带采集铀。',                         reqs: { kuiper: 2 },                       baseCost: { Money: 17500000, Polymer: 500000, Stanene: 250000, Aerogel: 100000 }, costMult: 1.28, power: 6, effectDesc: '+ Uranium 产出。' },
  { id: 'neutronium_mine',  region: 'kuiper', name: '中子素矿',       desc: '柯伊伯带中的超致密矿物。',                   reqs: { kuiper: 2 },                       baseCost: { Money: 28000000, Bolognium: 175000, Vitreloy: 45000 }, costMult: 1.28, power: 8, effectDesc: '+ Neutronium 产出。' },

...
- 已完成：进化阶段（简化版，5 种族直选）、资源系统（含铀）、建造队列、建筑系统（39 座，含核电站）、本地存档、工匠/冶金、政府（5 种政体）、金融、仓储、娱乐、士气/压力系统、电力网格（煤电/油电/核电）、军事系统（兵营/训练营/佣兵/战役/狩猎）、贸易（手动 + 自动路线）、随机事件系统（23 个事件）、牧师/信仰产出、神龛建筑、工厂产线（合金/聚合物）、生物实验室/赌场/码头/旅游中心、种族特性（9/10 已激活，Human creative 待 ARPA）、科技树（114 项，全部可达）、行星特性系统（7 个活跃特性：unstable/dense/mellow/rage/magnetic/trashed/permafrost）。
- 部分完成：宗教、日历/季节/天气。
- 当前重点：还原完整进化树。
- 后续计划：扩展种族数量、ARPA 长线研究。
...
- 高级电力（核电/太阳能）与工厂产线
- 高级建筑（赌场/码头/旅游中心/生物实验室等）
- 政体扩展与发现时代科技
- 间谍/外交系统完善
- ARPA 长线研究项目（超级对撞机/基因组/纳米机器人）

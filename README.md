...
- 已完成：进化阶段（简化版，5 种族直选）、资源系统、建造队列、建筑系统（33 座）、本地存档、工匠/冶金、政府（5 种政体）、金融、仓储、娱乐、士气/压力系统、电力网格（煤电/油电）、军事系统（兵营/训练营/佣兵/战役/狩猎）、贸易（手动 + 自动路线）。
- 部分完成：科技树（95 个科技）、岗位系统（14 个岗位）、宗教、日历/季节/天气。
- 当前重点：随机事件系统、工厂产线（合金/聚合物），以及文明时代剩余建筑/资源/科技收尾。
